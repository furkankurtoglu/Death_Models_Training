...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name6 = Button(description='rupture_volume', disabled=True, layout=name_button_layout)
        param_name6.style.button_color = 'tan'

        self.rupture_volume = FloatText(
          value=4988,
          step=100,
          style=style, layout=widget_layout)

        param_name7 = Button(description='relative_rupture_volume', disabled=True, layout=name_button_layout)
        param_name7.style.button_color = 'lightgreen'

        self.relative_rupture_volume = FloatText(
          value=2.0,
          step=0.1,
          style=style, layout=widget_layout)

        param_name8 = Button(description='o2_necrosis_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name9 = Button(description='o2_necrosis_max', disabled=True, layout=name_button_layout)
        ...
        param_name10 = Button(description='cytoplasmic_biomass_change_rate', disabled=True, layout=name_button_layout)
        ...
        param_name11 = Button(description='nuclear_biomass_change_rate', disabled=True, layout=name_button_layout)
        ...
        param_name12 = Button(description='lysed_fluid_change_rate', disabled=True, layout=name_button_layout)
        ...
        param_name13 = Button(description='unlysed_fluid_change_rate', disabled=True, layout=name_button_layout)
        ...
        desc_button2 = Button(description='1->apoptosis 2->necrosis', disabled=True, layout=desc_button_layout) 
        desc_button2.style.button_color = 'tan'
        desc_button3 = Button(description='initial tumor radius', disabled=True, layout=desc_button_layout) 
        desc_button3.style.button_color = 'lightgreen'
        desc_button5 = Button(description='mean apoptosis rate', disabled=True, layout=desc_button_layout) 
        desc_button5.style.button_color = 'lightgreen'
        desc_button6 = Button(description='mean necrosis rate', disabled=True, layout=desc_button_layout) 
        desc_button6.style.button_color = 'tan'
        desc_button7 = Button(description='1->deterministic 2->stochastic', disabled=True, layout=desc_button_layout) 
        desc_button7.style.button_color = 'lightgreen'
        desc_button8 = Button(description='volume at which a cell will burst or lyse', disabled=True, layout=desc_button_layout) 
        desc_button8.style.button_color = 'tan'
        desc_button9 = Button(description='relative_rupture_volume', disabled=True, layout=desc_button_layout) 
        desc_button9.style.button_color = 'lightgreen'
        desc_button10 = Button(description='oxygen threshold level for dying with necrotic death', disabled=True, layout=desc_button_layout) 
        desc_button10.style.button_color = 'tan'
        desc_button11 = Button(description='oxygen threshold level for maximum rate of necrotic death', disabled=True, layout=desc_button_layout) 
        desc_button11.style.button_color = 'lightgreen'
        desc_button12 = Button(description='rate of degradation for solids in the cytoplasm other than the nucleus', disabled=True, layout=desc_button_layout) 
        desc_button12.style.button_color = 'tan'
        desc_button13 = Button(description='rate of degradation for nucleus solids', disabled=True, layout=desc_button_layout) 
        desc_button13.style.button_color = 'lightgreen'
        desc_button14 = Button(description='rate of fluid change (cytoplasmic fluid) after cell lysis ', disabled=True, layout=desc_button_layout) 
        desc_button14.style.button_color = 'tan'
        desc_button15 = Button(description='rate of fluid change (cytoplasmic fluid) before cell lysis', disabled=True, layout=desc_button_layout) 
        desc_button15.style.button_color = 'lightgreen'

        row2 = [param_name1, self.type_of_death_model, units_button1, desc_button2] 
        row3 = [param_name2, self.initial_tumor_radius, units_button2, desc_button3] 
        row5 = [param_name3, self.apoptosis_rate, units_button3, desc_button5] 
        row6 = [param_name4, self.necrosis_rate, units_button4, desc_button6] 
        row7 = [param_name5, self.necrosis_type, units_button5, desc_button7] 
        row8 = [param_name6, self.rupture_volume, units_button6, desc_button8] 
        row9 = [param_name7, self.relative_rupture_volume, units_button7, desc_button9] 
        row10 = [param_name8, self.o2_necrosis_threshold, units_button8, desc_button10] 
        row11 = [param_name9, self.o2_necrosis_max, units_button9, desc_button11] 
        row12 = [param_name10, self.cytoplasmic_biomass_change_rate, units_button10, desc_button12] 
        row13 = [param_name11, self.nuclear_biomass_change_rate, units_button11, desc_button13] 
        row14 = [param_name12, self.lysed_fluid_change_rate, units_button12, desc_button14] 
        row15 = [param_name13, self.unlysed_fluid_change_rate, units_button13, desc_button15] 
    ...
    def fill_gui(self, xml_root):
        ...
        self.rupture_volume.value = float(uep.find('.//rupture_volume').text)
        self.relative_rupture_volume.value = float(uep.find('.//relative_rupture_volume').text)
    ...
    def fill_xml(self, xml_root):
        ...
        uep.find('.//rupture_volume').text = str(self.rupture_volume.value)
        uep.find('.//relative_rupture_volume').text = str(self.relative_rupture_volume.value)
