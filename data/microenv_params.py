...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        self.oxygen_initial_condition = FloatText(value=1.0,style=style, layout=widget_layout)
        param_name4 = Button(description='Dirichlet_boundary_condition', disabled=True, layout=name_button_layout)

        self.oxygen_Dirichlet_boundary_condition = FloatText(value=1.0,style=style, layout=widget_layout)
